  ...
  <div>
    ...
    <div class="form-input p-0" :class="{ error: errors.length }">
      ...
      <div v-if="!modelValue" class="p-2">
        <button type="button"
          class="flex items-center px-4 py-1 text-white text-xs font-medium bg-gray-500 hover:bg-gray-700 rounded-sm"
          @click="browse">
          <icon name="input" class="justify-start fill-white h-4 w-4 mr-1" />Carregar Certificado
        </button>
      </div>
